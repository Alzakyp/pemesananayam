                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <form action="{{ route('pesanan.update', $pesanan->id) }}" method="POST">
                            ...
                            <div class="row mb-3">
                                    ...
                                    <div class="form-group mb-3">
                                        ...
                                        <select class="form-control @error('id_pelanggan') is-invalid @enderror" id="id_pelanggan" name="id_pelanggan" required>
                                            ...
                                            @foreach($pelanggans as $pelanggan)
                                                <option value="{{ $pelanggan->id }}" {{ old('id_pelanggan', $pesanan->id_pelanggan) == $pelanggan->id ? 'selected' : '' }}>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group mb-3">
                                        ...
                                        <textarea class="form-control @error('alamat_pengiriman') is-invalid @enderror" id="alamat_pengiriman" name="alamat_pengiriman" rows="3" required>{{ old('alamat_pengiriman', $pesanan->alamat_pengiriman) }}</textarea>
                            ...
                            <div class="row mb-3">
                                    ...
                                    <div class="form-group mb-3">
                                        ...
                                        <select class="form-control @error('id_produk') is-invalid @enderror" id="id_produk" name="id_produk" required>
                                            ...
                                            @foreach($produks as $produk)
                                                <option value="{{ $produk->id }}" data-harga="{{ $produk->harga }}" {{ old('id_produk', $pesanan->id_produk) == $produk->id ? 'selected' : '' }}>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group mb-3">
                                        ...
                                        <input type="number" class="form-control @error('total_bayar') is-invalid @enderror" id="total_bayar" name="total_bayar" value="{{ old('total_bayar', $pesanan->total_bayar) }}" min="0" required>
                                        @error('total_bayar')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group mb-3">
                                        ...
                                        <select class="form-control @error('metode_pembayaran') is-invalid @enderror" id="metode_pembayaran" name="metode_pembayaran" required>
                                            ...
                                            <option value="Midtrans" {{ old('metode_pembayaran', $pesanan->metode_pembayaran) == 'Midtrans' ? 'selected' : '' }}>Midtrans (Online)</option>
                                            <option value="Tunai" {{ old('metode_pembayaran', $pesanan->metode_pembayaran) == 'Tunai' ? 'selected' : '' }}>Tunai</option>
                                        </select>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group mb-3">
                                        ...
                                        <select class="form-control @error('metode_pengiriman') is-invalid @enderror" id="metode_pengiriman" name="metode_pengiriman" required>
                                            ...
                                            <option value="Delivery" {{ old('metode_pengiriman', $pesanan->metode_pengiriman) == 'Delivery' ? 'selected' : '' }}>Delivery</option>
                                            <option value="Pick Up" {{ old('metode_pengiriman', $pesanan->metode_pengiriman) == 'Pick Up' ? 'selected' : '' }}>Pick Up</option>
                                        </select>
                            ...
                            <!-- Fields Tanggal Pengiriman dan Status -->
                            <div class="row mb-3">
                                <div class="col-md-6">
                                    <div class="form-group mb-3">
                                        <label for="tanggal_pengiriman">Tanggal Pengiriman</label>
                                        <input type="date" class="form-control @error('tanggal_pengiriman') is-invalid @enderror" id="tanggal_pengiriman" name="tanggal_pengiriman" value="{{ old('tanggal_pengiriman', $pesanan->tanggal_pengiriman ? $pesanan->tanggal_pengiriman->format('Y-m-d') : '') }}">
                                        <small class="form-text text-muted">Kosongkan untuk pengiriman hari ini</small>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group mb-3">
                                        ...
                                        <select class="form-control @error('status') is-invalid @enderror" id="status" name="status" required>
                                            <option value="Mempersiapkan" {{ old('status', $pesanan->status) == 'Mempersiapkan' ? 'selected' : '' }}>Mempersiapkan</option>
                                            <option value="Proses pengantaran" {{ old('status', $pesanan->status) == 'Proses pengantaran' ? 'selected' : '' }}>Proses pengantaran</option>
                            ...
                            <div class="row mb-3">
                                <div class="col-md-6">
                                    <div class="form-group mb-3 delivery-only" style="{{ $pesanan->metode_pengiriman == 'Delivery' ? '' : 'display: none;' }}">
                                        <label for="lokasi_maps">Lokasi Maps <span class="text-info">(Opsional)</span></label>
                                        <input type="text" class="form-control @error('lokasi_maps') is-invalid @enderror" id="lokasi_maps" name="lokasi_maps" value="{{ old('lokasi_maps', $pesanan->lokasi_maps) }}" placeholder="contoh: -6.123456,106.123456">
