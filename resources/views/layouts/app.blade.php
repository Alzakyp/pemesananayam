...
.dashboard-subtitle {
    ...
    color: #6c757d; /* Warna teks subtitle */
}
            ...
            <div class="d-flex" id="wrapper" data-aos="fade-right">
                ...
                <div class="border-right" id="sidebar-wrapper">
                    <div class="sidebar-heading text-center">
                        ...
                        <img src="../assets/images/LOGO AYAMKU.png" alt="" class="my-2" style="width: 150px; height: 149px;" />
                    ...
                    <div class="list-group list-group-flush">
                        ...
                        <div class="dropdown">
                            ...
                            <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                <a class="dropdown-item {{ Request::is('transactions') ? 'active' : '' }}" href="{{ route('pembayaran.index') }}">All Transactions</a>
                                <a class="dropdown-item {{ Request::is('transactions-no-confirm') ? 'active' : '' }}" href="?page=transactions-no-confirm">Belum Konfirmasi</a>
                                <a class="dropdown-item {{ Request::is('transactions-confirm') ? 'active' : '' }}" href="?page=transactions-confirm">Konfirmasi</a>
                                <a class="dropdown-item {{ Request::is('transactions-pickup') ? 'active' : '' }}" href="?page=transactions-pickup">Pick Up</a>
                                <a class="dropdown-item {{ Request::is('transactions-sent') ? 'active' : '' }}" href="?page=transactions-sent">Terkirim</a>
                            </div>
                        </div>
                        <a href="{{ route('user.index') }}" class="list-group-item list-group-item-action {{ Request::is('users') ? 'active' : '' }}">
                            Data Pengguna
                        </a>
                                ...
                                <ul class="navbar-nav d-none d-lg-flex ml-auto">
                                    <li class="nav-item dropdown">
                                        <a href="#" class="nav-link" id="navbarDropdown" role="button" data-toggle="dropdown">
                                            <img src="{{ asset('assets/images/person-circle.svg') }}" alt="profile" height="40px" class="rounded-circle mr-2 profile-picture" />
                                            Hi, {{ Auth::user()->nama }}
                                        </a>                                        
